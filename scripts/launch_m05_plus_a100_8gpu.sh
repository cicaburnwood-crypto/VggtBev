...
"$python_bin" scripts/build_incomplete_session_index.py \
    --manifest "$manifest" \
    --session-record-cache "$session_cache" \
    --output "$incomplete_index" \
    --workers "${VGGT_BEV_COMPLETENESS_WORKERS:-128}"
